...
class LibraryService(BaseService):
    ...
    def save_items(self, uris: list[str]) -> None:
        ...
        self._put("/me/library", params={"uris": ",".join(uris)})

    def remove_items(self, uris: list[str]) -> None:
        ...
        """
        self._validate_uris(uris)
        self._delete("/me/library", params={"uris": ",".join(uris)})

    def check_contains(self, uris: list[str]) -> list[bool]:
