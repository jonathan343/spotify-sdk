...
class TestUserServiceGetCurrentProfile:
    @pytest.mark.anyio
    async def test_get_current_profile(self, httpx_mock: HTTPXMock):
...
class TestUserServiceGetTopArtists:
    @pytest.mark.anyio
    async def test_get_top_artists(self, httpx_mock: HTTPXMock):
        httpx_mock.add_response(
    ...
    @pytest.mark.anyio
    async def test_get_top_artists_with_filters(self, httpx_mock: HTTPXMock):
        httpx_mock.add_response(
            url=(
    ...
    @pytest.mark.anyio
    async def test_get_top_artists_invalid_time_range_raises_error(self):
        async with AsyncSpotifyClient(access_token="test-token") as client:
            with pytest.raises(ValueError, match="Invalid time_range"):
                await client.users.get_top_artists(
...
class TestUserServiceGetTopTracks:
    @pytest.mark.anyio
    async def test_get_top_tracks(self, httpx_mock: HTTPXMock):
        httpx_mock.add_response(
        ...
        async with AsyncSpotifyClient(access_token="test-token") as client:
            page = await client.users.get_top_tracks()
...
class TestUserServiceFollowPlaylist:
    @pytest.mark.anyio
    async def test_follow_playlist_empty_id_raises_error(self):
        async with AsyncSpotifyClient(access_token="test-token") as client:
            with pytest.raises(ValueError, match="id cannot be empty"):
                await client.users.follow_playlist("")

    @pytest.mark.anyio
    async def test_follow_playlist_defaults_to_public(
        ...
        async with AsyncSpotifyClient(access_token="test-token") as client:
            await client.users.follow_playlist("playlist123")
    ...
    @pytest.mark.anyio
    async def test_follow_playlist_private(self, httpx_mock: HTTPXMock):
        httpx_mock.add_response(
            url="https://api.spotify.com/v1/playlists/playlist123/followers",
            method="PUT",
            status_code=204,
        ...
        async with AsyncSpotifyClient(access_token="test-token") as client:
            await client.users.follow_playlist("playlist123", public=False)
...
class TestUserServiceUnfollowPlaylist:
    @pytest.mark.anyio
    async def test_unfollow_playlist_empty_id_raises_error(self):
        async with AsyncSpotifyClient(access_token="test-token") as client:
            with pytest.raises(ValueError, match="id cannot be empty"):
                await client.users.unfollow_playlist("")

    @pytest.mark.anyio
    async def test_unfollow_playlist(self, httpx_mock: HTTPXMock):
        httpx_mock.add_response(
            url="https://api.spotify.com/v1/playlists/playlist123/followers",
            method="DELETE",
            status_code=204,
        ...
        async with AsyncSpotifyClient(access_token="test-token") as client:
            await client.users.unfollow_playlist("playlist123")
...
class TestUserServiceGetFollowedArtists:
    @pytest.mark.anyio
    async def test_get_followed_artists(self, httpx_mock: HTTPXMock):
        httpx_mock.add_response(
    ...
    @pytest.mark.anyio
    async def test_get_followed_artists_with_cursor_and_limit(
        self, httpx_mock: HTTPXMock
    ):
        httpx_mock.add_response(
            url=(
...
class TestUserServiceFollowArtistsOrUsers:
    @pytest.mark.anyio
    async def test_follow_artists_or_users_empty_ids_raises_error(self):
        async with AsyncSpotifyClient(access_token="test-token") as client:
            with pytest.raises(ValueError, match="ids cannot be empty"):
                await client.users.follow_artists_or_users("artist", [])

    @pytest.mark.anyio
    async def test_follow_artists_or_users_invalid_type_raises_error(self):
        async with AsyncSpotifyClient(access_token="test-token") as client:
    ...
    @pytest.mark.anyio
    async def test_follow_artists_or_users(self, httpx_mock: HTTPXMock):
        httpx_mock.add_response(
            url=(
                "https://api.spotify.com/v1/me/following"
...
class TestUserServiceUnfollowArtistsOrUsers:
    @pytest.mark.anyio
    async def test_unfollow_artists_or_users_empty_ids_raises_error(self):
        async with AsyncSpotifyClient(access_token="test-token") as client:
            with pytest.raises(ValueError, match="ids cannot be empty"):
                await client.users.unfollow_artists_or_users("user", [])

    @pytest.mark.anyio
    async def test_unfollow_artists_or_users_invalid_type_raises_error(self):
        async with AsyncSpotifyClient(access_token="test-token") as client:
            with pytest.raises(ValueError, match="Invalid type_"):
    ...
    @pytest.mark.anyio
    async def test_unfollow_artists_or_users(self, httpx_mock: HTTPXMock):
        httpx_mock.add_response(
            url=(
                "https://api.spotify.com/v1/me/following"
...
class TestUserServiceCheckFollowsArtistsOrUsers:
    @pytest.mark.anyio
    async def test_check_follows_artists_or_users(self, httpx_mock: HTTPXMock):
        httpx_mock.add_response(
            url=(
        ...
        async with AsyncSpotifyClient(access_token="test-token") as client:
            result = await client.users.check_follows_artists_or_users(
                "user", ["user123", "user456"]
            )
    ...
    @pytest.mark.anyio
    async def test_check_follows_artists_or_users_empty_ids_raises_error(
        self,
    ):
        async with AsyncSpotifyClient(access_token="test-token") as client:
            with pytest.raises(ValueError, match="ids cannot be empty"):
...
class TestUserServiceCheckIfFollowsPlaylist:
    @pytest.mark.anyio
    async def test_check_if_follows_playlist_empty_id_raises_error(self):
        async with AsyncSpotifyClient(access_token="test-token") as client:
            with pytest.raises(ValueError, match="id cannot be empty"):
                await client.users.check_if_follows_playlist("", ["user123"])

    @pytest.mark.anyio
    async def test_check_if_follows_playlist_empty_user_ids_raises_error(
        self,
    ):
        async with AsyncSpotifyClient(access_token="test-token") as client:
            with pytest.raises(ValueError, match="user_ids cannot be empty"):
                await client.users.check_if_follows_playlist("playlist123", [])

    @pytest.mark.anyio
    async def test_check_if_follows_playlist(self, httpx_mock: HTTPXMock):
        httpx_mock.add_response(
            url=(
        ...
        async with AsyncSpotifyClient(access_token="test-token") as client:
            result = await client.users.check_if_follows_playlist(
